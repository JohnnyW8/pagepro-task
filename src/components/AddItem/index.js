...
import { WrapperForm, WrapperTextarea, WrapperButtons, ButtonIcon, Button } from './style'
    ...
    return (
        <>  
            ...
            <ModalWrapper show={showModal} close={handleClose} >
                <WrapperForm >
                    <Title title={title} />
                    <Form onSubmit={data => handleSumbit(data)} requiredErrorText="Field is required" recaptchaInfoRef="">
                        {isPostModal
                            ? <Input required={true} name='title' type='text' rule='text' placeholder='Title' />
                            : <>
                                <Input required={true} name='email' type='email' rule='email' placeholder='Email' />
                                <Input required={true} name='name' type='text' rule='text' placeholder='Name' />
                            </>
                        }
                        ...
                        <WrapperButtons>
                            <Button type="button" color="dark" onClick={handleClose}>Cancel</Button>
